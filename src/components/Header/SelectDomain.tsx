        ...
        <ContentWrap>
                ...
                <div className="popover_input">
                    <DefaultInput value={keyword} size="large" suffix={<SearchOutlined />}
                        ...
                        placeholder={intl.formatMessage({
                            id: 'components.header.selectDomain.search'
                        })} />
                </div>
            </div>
            {/* 店铺项 */}
            <Spin spinning={loading}>
                {<div ref={scrollRef} className="popover_content" onScroll={handleScroll}>{
                            ...
                            <div className="popover_item" key={index} onClick={() => {
                                ...
                                <div className="storeInfo">
                                    <div className="storeName">
                                        ...
                                        {item?.status == 1 && <SuccessTag text={intl.formatMessage({id:"components.header.selectDomain.runningStores"})} />}
                                        {item?.status == 0 && <DefaultTag text={intl.formatMessage({id:"components.header.selectDomain.defaultStores"})} />}
                                    </div>
                    ...
                    >
                        {intl.formatMessage({id:'components.header.selectDomain.none'})}
                    </Flex>
                }
                </div>}
                {loadingMore && (
