...
export default function SecondTinyMce({content,setContent,onEditorInit}:{content:string,setContent:any,onEditorInit?: (editor: any) => void}){  
    ...
    <>  
      <Editor  
        ...
        init={{
          ...
          toolbar:
          'bold italic strikethrough underline | fontsize | forecolor alignleft aligncenter alignright alignjustify',
