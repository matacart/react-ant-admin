...
function Notification() {
    ...
    const [customTemplateConfig,setCustomTemplateConfig] = useState([
        ...
        {key:"CUSTOMER_SEND_MESSAGE", title:"联系客户", content:"当订单包裹配送信息更新时，向客户发送此通知邮件（如果您选择此项）",type:"customer"},
        {key:"COMPANY_VISITOR_NOTICE_EMAIL", title:"B2B访问电子邮件", content:"当订单被取消时，向客户发送此通知邮件",type:"customer"},
        ...
        {key:"ORDER_ACTION_EMAIL_LOCAL_SHIPPING_START", title:"正在配送", content:"在客户的本地订单正在配送时发送给客户",type:"localDistribution"},
        {key:"ORDER_ACTION_EMAIL_LOCAL_SHIPPING_SUCCESS", title:"已送达", content:"在客户的本地订单已送达时发送给客户",type:"localDistribution"},
        {key:"ORDER_ACTION_EMAIL_LOCAL_SHIPPING_FAILED", title:"配送未成功", content:"在配送未成功时发送给客户",type:"localDistribution"},
        {key:"SHIPPING_UPDATE_OUT_FOR_DELIVERY", title:"正在派送", content:"在订单的运单号状态为正在配送时发送",type:"logisticsUpdate"},
        {key:"SHIPPING_UPDATE_DELIVERIED", title:"已送达", content:"在订单的运单号状态为已送达时发送",type:"logisticsUpdate"},
