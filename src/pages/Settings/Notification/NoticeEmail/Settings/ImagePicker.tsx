...
import { AddIcon, LeftIcon, SearchSecondIcon } from "@/components/Icons/Icons";
...
const ImagePicker = ({
    ...
    setting:settingType,
    data:any,
    setSections:(id:string,value:any)=>void,
    ...
    const submit = ()=>{
        setValue(imgUrl);
        // 同步
        setSections(setting.id,{value: imgUrl});
        setOpen(false);
    }
            ...
            {value ?
                <div className="preview">
                    ...
                    <Flex className="button-box" gap={12}>
                        <div style={{width:"100%"}}>
                            <MyButton style={{width:"100%",height:"36px"}} text={"更换图片"} onClick={changeImg} />
                        </div>
                        <div style={{width:"100%"}}>
                            <MyButton style={{width:"100%",height:"36px"}} text={"删除"} onClick={deleteUrl} />
                        </div>
                    </Flex>
                </div>
