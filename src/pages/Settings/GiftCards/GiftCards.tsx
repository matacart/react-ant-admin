            ...
            {isSkeleton?<SkeletonCard />:<div className='mc-layout-wrap'>
                <div className="mc-layout">
                    ...
                    <div className='mc-layout-main'>
                        <div className='mc-layout-content'>
                            <div className="mc-layout-content-left">
                                <div className="font-20 color-242833 font-w-600">自动失效</div>
                                <p className="font-12 color-474F5E desc line-h-20">将您的礼品卡设置为在购买/发放后的一段时间内过期。</p>
                            </div>
                    ...
                    <div className='mc-layout-main'>
                        <div className='mc-layout-content'>
                            <div className="mc-layout-content-left">
                                <div className="font-20 color-242833 font-w-600">礼品卡展示</div>
                                <p className="font-12 color-474F5E desc line-h-20">设置发送给用户的礼品卡可展示二维码或条形码。</p>
                            </div>
                            <div className="mc-layout-content-right">
                                <GiftCardDisplay />
                            </div>
