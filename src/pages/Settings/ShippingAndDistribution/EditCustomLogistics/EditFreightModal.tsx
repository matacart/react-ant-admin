                                    ...
                                    {fields.map((field, index) => (
                                        <div className="setting-item">
                                            ...
                                            <Row className="mb-8" gutter={[10,10]}>
                                                <Col span={10}>
                                                    {billingConfig[billingMethod || 1].title }
                                                ...
                                                <Col span={6}>{billingConfig[billingMethod || 1].fields[0]}</Col>
                                                <Col span={2}></Col>
                                            </Row>
                                                            ...
                                                            <Row gutter={[10,10]} className="mb-12">
                                                                <Col span={10}>
                                                                    <Flex>
                                                                        ...
                                                                        >
                                                                            <InputNumber<number> disabled value={
                                                                                formFreight.getFieldValue(['settings', field.name, 'rules', name - 1, 'max'])
                                                                            } style={{width:"100%"}}/>
                                                                        </Form.Item>
                                                                    ...
                                                                    {fields.length > 1 && <Flex align="center" style={{height:"32px"}}>
                                                                        <MinusCircleOutlined onClick={() => {
                                                                            ...
                                                                            currentRules.forEach((_, idx) => {
                                                                                ...
                                                                                const prevMax = formFreight.getFieldValue([
                                                                                  'settings',
                                                                                  field.name,
                                                                                  'rules',
                                                                                  idx - 1,
