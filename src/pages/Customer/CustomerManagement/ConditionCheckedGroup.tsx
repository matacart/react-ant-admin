...
import { Checkbox, Flex, Input, Popover, Row, Select, Tooltip } from "antd"
...
function ConditionCheckedGroup({condition,index}:propsType){
    ...
    const content = (
        <div style={{minWidth:"128px"}}>
            <Flex gap={8}>
                <div>
                    <Checkbox.Group className="check-group" style={{ width: '100%',display:"flex",flexDirection:"column" }} value={checkList} onChange={(e:string[])=>{
                        setCheckList(e)
                    }}>
...
export default ConditionCheckedGroup;
