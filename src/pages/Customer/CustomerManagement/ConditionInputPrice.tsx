...
import { Checkbox, Col, Flex, Form, Input, InputNumber, Row, Select, Tooltip } from "antd"
...
function ConditionInputPrice({condition,index}:propsType){
...
export default ConditionInputPrice;
