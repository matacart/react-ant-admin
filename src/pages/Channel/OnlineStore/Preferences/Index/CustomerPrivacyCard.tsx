...
function CustomerPrivacyCard() {
    ...
    useEffect(()=>{
        console.log("CustomerPrivacyCar",preferences.passWord)
    },[])
        ...
        <Scoped>
            <Card>
                ...
                <div>
                    <Radio.Group
                        style={style}
                        value={preferences.passWord.gdprState}
                        onChange={(e)=>{
                            preferences.setPassWord({
                                ...preferences.passWord,
                                gdprState:e.target.value
                            })
                        }}
                        options={[
                            {
...
export default observer(CustomerPrivacyCard)
