        ...
        <Scoped>
            <Card className="gap">
                <div className="header">
                    ...
                    <DefenseModal adStatus={articles.articles.ad_waf_status} adData={articles.articles} setAdData={setAdData}  />
                </div>
                <div className="item between">
                    ...
                    <Switch onChange={(e) => {
                        ...
                        checked={articles.articles.ad_waf_status == '1'?true:false}
                    />
                </div>
            </Card>
        </Scoped>
