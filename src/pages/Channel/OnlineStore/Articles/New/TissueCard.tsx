            ...
            <Card className="card">
                ...
                <Form form={form} layout="vertical">
                    <Form.Item
                        ...
                        <Input placeholder="请输入" defaultValue={articles.newArticles.author_name?articles.newArticles.author_name:""} onChange={(e) =>articles.setNewArticles({
                    ...
                    <Form.Item
                        ...
                        <Select
                            defaultValue={articles.newArticles.category_id}
                            placeholder="请选择"
                            dropdownRender={(menu) => (
                                <>
                                {menu}
