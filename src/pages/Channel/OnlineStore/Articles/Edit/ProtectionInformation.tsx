        ...
        <Scoped>
            <Card className="gap">
                <div className="header">
                    ...
                    <DefenseModal adStatus={articles.oldArticles.ad_waf_status} adData={articles.oldArticles} setAdData={setAdData}  />
                </div>
                <div className="item between">
                    ...
                    <Switch onChange={(e) => {
                        ...
                        checked={articles.oldArticles.ad_waf_status == '1'?true:false}
                    />
                </div>
            </Card>
        </Scoped>
