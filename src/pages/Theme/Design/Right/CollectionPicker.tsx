...
function CollectionPicker({item,data,setData}:{item:any,data:DataType,setData:(item:any,value:DataType)=>void}){
            ...
            >
                <>
                    ...
                    <Flex className="menu_item" align="center" justify="center" gap={6} onClick={()=>history.push('/products/categories')} >
                        ...
                        <div className="color-356DFF">创建商品分类</div>
                    </Flex>
                </>
            </Drawer>
        </Scoped>
