        ...
        <>
            <div className="item" onClick={()=>setOpen(true)}>
                <Flex align='center' gap={8} className='color-356DFF' style={{padding: "4px 0"}} >
                    ...
                    <span>{intl.formatMessage({id:'theme.design.header.navigation.createTemplate'})}</span>
                </Flex>
            </div>
           
            <Modal width="480px" title={intl.formatMessage({id:'theme.design.header.navigation.createTemplate'})} centered open={open} onCancel={()=>{
                setOpen(false);
                // 初始化
            }}
            ...
            >
                <Scoped>
                    <Form className="form" form={form} layout="vertical">
                        ...
                        <Form.Item label={intl.formatMessage({id:'theme.design.header.modalBasedOnTemplate'})} name="source">
