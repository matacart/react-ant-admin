...
import ModifyPriceModal from "./Modify/ModifyPriceModal";
import DefaultButton from "@/components/Button/DefaultButton";
import ModifyDeteleModal from "./Modify/ModifyDeteleModal";
...
function SelectedActions({onFetchData}: {onFetchData:any }) {
    ...
    const controlsItems: MenuProps['items'] = [
      ...
      {
        label: <ModifyPriceModal type="specls" onFetchData={onFetchData} />,
        key: '7',
      },
      {
        label: <ModifyPriceModal type="origin" onFetchData={onFetchData} />,
        key: '8',
      },
      {
        label: <div>修改重量</div>,
      ...
      {
        label: <ModifyDeteleModal count={selectedCount} onFetchData={onFetchData} />,
        key: '12',
      },
    ];
