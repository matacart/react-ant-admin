...
function EditProductCategories(){
    ...
    useEffect(()=>{
        ...
        getCategory(id??"",languageId).then(res=>{
            categories.setLanguagesId(languageId);
                ...
                <div className="mc-layout">
                    <div className="mc-header">
                        ...
                        <Flex className='mc-header-right' gap={8}>
                            <LangSelect lang={languageId} setLang={(value:string)=>history.push(`/products/categories/edit/${id}/${value}`)} />
                    ...
                    <div className='mc-footer'>
                        <PrimaryButton loading={loading} text="更新" onClick={()=>{
                            ...
                            setCategory({
                                ...
                                languages_id:categories.languagesId
                            }).then(res=>{
