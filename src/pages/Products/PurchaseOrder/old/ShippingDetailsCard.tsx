...
function ShippingDetailsCard() {
    ...
    useEffect(()=>{
        let tempList = [];
        if(courierList.length==0 && JSON.parse(sessionStorage["currency"])){
        ...
        // 
        form.setFieldsValue({shippings:purchaseOrderEdit.shipments})
    },[])
                                    ...
                                    <div style={{flex:"1"}}>
                                        <Row gutter={[20,0]}>
                                            <Col span={8}>
                                                ...
                                                >
                                                    <DatePicker style={{width:"100%"}} onChange={(values)=>{
