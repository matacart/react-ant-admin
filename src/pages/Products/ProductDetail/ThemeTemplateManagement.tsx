...
export default function ThemeTemplateManagement() {
    ...
    const reset = ()=>{
        ...
        form.setFieldsValue({
            ...
            themeLanguage:product.productInfo.cod_languages_id ? product.productInfo.cod_languages_id : undefined,
    ...
    useEffect(()=>{
        ...
        setCurrencyList(currencies.map((item:any)=>{
            return {label:item.title+" ("+item.code+")",value:item.code}
        }))
        ...
        <>
            ...
            >
                <MyForm form={form} layout="vertical" style={{marginTop:"20px"}}>
                    ...
                    {currency == "TWD" && <Flex gap={12} style={{marginBottom:"24px"}}>
                        <div>台湾商超:</div>
