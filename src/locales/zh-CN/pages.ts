export default {
  ...
  'pages.login.username.label': '用户名/手机号',
  'pages.login.password.label': '密码',
  'pages.login.welcome': '欢迎来到',
  'pages.login.link.google': '使用 Google 登录',
  'pages.login.link.facebook': '使用 Facebook 登录',
  'pages.login.link.apple': '使用 Apples 登录',
  'pages.login.link.linkie': '使用 Linkie 登录',
  'pages.register.link.google': '使用 Google 注册',
  'pages.register.link.facebook': '使用 Facebook 注册',
  'pages.register.link.apple': '使用 Apples 注册',
  'pages.register.link.linkie': '使用 Linkie 注册',
